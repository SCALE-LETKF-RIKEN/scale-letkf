...
echo "scale-rm_init"
mpiexec -std-proc log/scale_init/NOUT -n 48 ./scale-rm_init config/scale-rm_init_ens_20220101000000.conf
echo "scale-rm"
mpiexec -std-proc log/scale/NOUT -n 48 ./scale-rm config/scale-rm_ens_20220101000000.conf
